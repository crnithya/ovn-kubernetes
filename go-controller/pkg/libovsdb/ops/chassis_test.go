...
func TestCreateOrUpdateChassis(t *testing.T) {
	...
	tests := []struct {
		...
		{
			desc:    "update chassis by adding new encap record",
		...
		{
			desc:    "update chassis by removing unused encap record",
		...
		{
			desc:    "update chassis by adding new encap record and deleting old encap record",
